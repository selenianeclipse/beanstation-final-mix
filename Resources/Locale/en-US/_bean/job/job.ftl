...
calamitydev-message = (OOC) this locker is incomplete. i don't know what to put in here. please forward ideas. also forward ideas if you have any for uplink items. -calamity

uplink-sros-name = SROS Injector
uplink-sros-desc = Gift (or curse) someone with immortality! Note. We are not responsible for side effects such as eye damage, mental deterioration, physical atrophy, extreme hunger, necrosis

uplink-ichor-name = Ichorubizine Injector
uplink-ichor-desc = Tired of all these immortal freaks running around? Just hit 'em with this, and shoot them in the head!
...
job-supervisors-cencomonly = only Central Command
...
loadout-group-outlaw-neck = Outlaw neck
